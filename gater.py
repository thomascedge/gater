...
class Gater():
    ...
    def start_model(self, user_input, max_seq_len, source_mask, device):
        ...
        tokenizer_target = Tokenizer.from_file(f'./tokenizer_en/tokenizer_{self.language}.json')
        ...
        checkpoint_number = 9
        model_filename = f'./gater/model_{checkpoint_number}.pt'
    ...
    def translate(self, text):
        ...
        self.start_model(text, max_seq_len, source_mask, device)
